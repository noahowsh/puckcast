  ...
  return (
    <div className="min-h-screen">
      <div className="container" style={{ paddingTop: "8rem" }}>
          ...
          <div className="card-elevated">
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem', alignItems: 'center' }}>
              ...
              <div>
                ...
                <div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.5rem' }}>
                    <span style={{ fontSize: '0.9rem', fontWeight: 600, color: 'var(--aqua)' }}>Puckcast V7.1</span>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-white mb-6">39 features explained (V7.1)</h2>
          <div className="card-elevated">
...
const faqItems = [
  {
    ...
    answer:
      "We generate fresh predictions daily at 10:00 AM and 10:00 PM UTC via automated GitHub Actions. The model pulls the latest stats from the NHL API and recalculates all 39 curated features (V7.1) before making predictions.",
  },
  {
