  ...
  return (
    <div className="min-h-screen">
      <div className="container" style={{ paddingTop: "8rem" }}>
        <PageHeader
          title="Betting Lab"
          description="Interactive strategy sandbox. Adjust edge thresholds to see historical win rate, ROI, and bankroll curves from backtesting across 4 NHL seasons."
          icon={
