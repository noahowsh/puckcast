          ...
          <div className="card-elevated max-w-4xl mx-auto">
            ...
            <div className="mb-8">
              <div className="flex items-center justify-between mb-4">
                <label className="text-sm font-semibold text-slate-300">Minimum Edge Threshold</label>
                <span className="text-3xl font-bold text-gradient-cyan">{edgeThreshold} pts</span>
              </div>
              <input
                type="range"
                min="0"
                ...
                style={{
                  background: `linear-gradient(to right, rgb(59, 130, 246) 0%, rgb(6, 182, 212) ${(edgeThreshold / 20) * 100}%, rgb(51, 65, 85) ${(edgeThreshold / 20) * 100}%, rgb(51, 65, 85) 100%)`,
                }}
              />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <StatCard
                label="Total Bets"
                value={activeStrategy.bets.toLocaleString()}
              />
              <StatCard
                label="ROI per Bet"
                value={`${roiPerBet}%`}
                ...
                {sortedStrategies.map((strategy) => {
                  ...
                  return (
                    <tr key={strategy.name}>
                      ...
                      <td className="text-sky-400">{(strategy.avgEdge * 100).toFixed(1)} pts</td>
                    </tr>
                  );
                })}
              </tbody>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="card">
              ...
              <div className="text-xs text-slate-500">
                Example: 60% win rate → Kelly suggests 20% of bankroll
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-300 leading-relaxed">
                  Puckcast is an analytics and educational platform, not a betting service. We do not recommend
                  specific wagers or guarantee profits. Past performance does not predict future results. Sports
                  betting involves risk - please gamble responsibly and only with money you can afford to lose.
                </p>
              </div>
            </div>
          </div>
