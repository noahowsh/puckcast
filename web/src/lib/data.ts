/**
 * Data Service - Provides access to static JSON data files
 *
 * This module loads and validates data from the /data directory:
 * - todaysPredictions.json: Daily game predictions
 * - goaliePulse.json: Goalie performance metrics
 * - modelInsights.json: Model accuracy and confidence data
 * - startingGoalies.json: Confirmed starting goalies
 * - playerInjuries.json: Current injury reports
 *
 * Data is generated by Python scripts and committed daily via GitHub Actions.
 */

// Error logging helper (Sentry integration can be added later)
